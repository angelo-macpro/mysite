...
CREATE TABLE `collector_accounttype` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `collector_accounttype_typename_0d1177a7_uniq` (`typename`)
...
-- ----------------------------
BEGIN;
INSERT INTO `collector_actualdata` VALUES (463, 10, 'GBCL', 'VE1110-2020-03-20/57');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `collector_version` VALUES ('2020-03-20 03:25:41.374189', '2020-03-20', 1, 'VE1110-2020-03-20/57', NULL, 'E1110');
INSERT INTO `collector_version` VALUES ('2020-03-20 03:21:51.320717', '2020-03-20', 1, 'VE1110-2020-03-20/61', NULL, 'E1110');
INSERT INTO `collector_version` VALUES ('2020-03-20 03:12:23.773356', '2020-03-20', 1, 'VE1110-2020-03-20/82', NULL, 'E1110');
COMMIT;
...
CREATE TABLE `collector_ytddata` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `collector_ytddata_version_id_ytdaccount_id_c9f29fc7_uniq` (`version_id`,`ytdaccount_id`),
...
-- ----------------------------
-- Records of collector_ytddata
-- ----------------------------
BEGIN;
INSERT INTO `collector_ytddata` VALUES (869, 11, 11, 'VE1110-2020-03-20/57', 'GBCL');
COMMIT;
...
INSERT INTO `django_migrations` VALUES (25, 'collector', '0008_auto_20200318_1933', '2020-03-18 11:33:40.576081');
INSERT INTO `django_migrations` VALUES (26, 'collector', '0008_auto_20200318_1934', '2020-03-19 13:18:33.896488');
INSERT INTO `django_migrations` VALUES (27, 'collector', '0009_auto_20200319_2118', '2020-03-19 13:18:34.516150');
INSERT INTO `django_migrations` VALUES (28, 'collector', '0010_auto_20200320_1512', '2020-03-20 07:12:40.434535');
COMMIT;
